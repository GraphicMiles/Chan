...
- **Serverless functions**: the Hobby plan gives you **12 functions per deployment**. This project uses **5** serverless functions (`room`, `moderate`, `createLiveKitToken`, `cleanupStaleRooms`, `media`) under the Hobby **12**-function cap.
